...
def readCommand(argv):
  ...
  """
    ...
    if options.textgraphics:
        ...
        import captureGraphicsDisplay_tan
        # Hack for agents writing to the display
        captureGraphicsDisplay_tan.FRAME_TIME = 0
        args['display'] = captureGraphicsDisplay_tan.PacmanGraphics(options.red, options.blue, options.zoom, 0,
                                                                capture=True)
        import __main__
